...
if score_input < 100:
    bonus = 5
elif 100 < score_input < 1000:
    bonus = score_input * 0.2
elif score_input > 1000:
    bonus = score_input * 0.1
...
total_score = score_input + bonus + bonus_1 + bonus_2

print(round(total_score - score_input, 2), total_score)
