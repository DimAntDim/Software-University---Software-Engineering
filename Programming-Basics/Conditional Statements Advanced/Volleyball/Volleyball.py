...
holidays_to_play = int(input("")) * 2/3

weekends_home_town = int(input(""))

time_to_play_sofia = (48-weekends_home_town) * 3/4

if year == 'leap':
    play = time_to_play_sofia + holidays_to_play + weekends_home_town
    play = (play + play * 0.15) //1
    print("%.f" % play)
else:
    play = (time_to_play_sofia + holidays_to_play + weekends_home_town) //1
    print("%.f" % play)
