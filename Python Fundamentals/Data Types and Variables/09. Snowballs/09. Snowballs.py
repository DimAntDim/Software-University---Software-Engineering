...
Constraints
The number of snowballs (N) will be an integer in range_shot [0, 100].
The snowball_snow is an integer in range_shot [0, 1000].
The snowball_time is an integer in range_shot [1, 500].
The snowball_quality is an integer in range_shot [0, 100].
Input
Output
2
10
...
n = int(input())
snowball_winner_snow = 0
snowball_winner_value = 0
snowball_winner_time = 0
snowball_winner_value = 0
snowball_winner_quality = 0
for i in range(n):
    snowball_snow = int(input())
    snowball_time = int(input())
    snowball_quality = int(input())
    snowball_value = int(snowball_snow / snowball_time) ** snowball_quality
    if snowball_value > snowball_winner_value:
        snowball_winner_value = snowball_value
        snowball_winner_snow = snowball_snow
        snowball_winner_time = snowball_time
        snowball_winner_quality = snowball_quality

print(f"{snowball_winner_snow} : {snowball_winner_time} = {snowball_winner_value} ({snowball_winner_quality})")